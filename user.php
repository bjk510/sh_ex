...
$sql = "INSERT INTO tbl_cards_92 (userID, city, address, comm)
VALUES ('".$_SESSION["username"]."','".$_GET["city"]."','".$_GET["address"]."','".$_GET["comm"]."')";

if ($conn->query($sql) === TRUE) {

  echo  '<div class="alert alert-success">';
      echo "<strong>Success!</strong> Your report is bieng processed.";
   echo"</div>";
    ...
    echo "<strong> Error: " . $sql . "</strong>" . $conn->error;
    echo"</div>";
}
};
?>
    ...
    <button type="button" class="hidden btn btn-primary btn-lg"></button>

         <div class="card shadow p-3 mb-5 bg-white rounded align-middle" >





<h4 class="card-title align-middle"> NEW REPORT</h4>
<a href="#" target="">

    <br>
    <img class="card-img-top " data-toggle="modal" data-target="#myModal"  src="includes/garb.jpg" alt="Card image">  </a>
<div class="card-body">
                    ...
                    <div class="modal-body">
                        <form action="user.php">
                                    ...
                                    <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Street and number" name="address">
